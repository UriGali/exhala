...
export const PLANT_SPECIES: PlantSpecies[] = [
  ...
  },
  {
    ...
    lore: 'Un olivo milenario con raíces indestructibles que corona tu libertad definitiva.',
    healingBenefit: 'Riesgo cardiovascular reducido a la mitad y esperanza de vida maximizada.',
    colorTheme: {
      primary: '#3E2723',
      secondary: '#556B2F',
      accent: '#D4AF37',
